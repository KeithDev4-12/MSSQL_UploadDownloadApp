...
type
  TDMMainModule = class(TDataModule)
    ...
    tblSQLMeterReading___: TFDTable;
    ...
    tblSQLMeterReading___MR_Sys_No: TStringField;
    tblSQLMeterReading___Acct_No: TStringField;
    tblSQLMeterReading___Mtr_No: TStringField;
    tblSQLMeterReading___PrevMR_Date: TSQLTimeStampField;
    tblSQLMeterReading___MR_Date: TSQLTimeStampField;
    tblSQLMeterReading___Prev_Rdg: TBCDField;
    tblSQLMeterReading___Cur_Rdg: TBCDField;
    tblSQLMeterReading___Cur_Consumption: TBCDField;
    tblSQLMeterReading___Rdg_Adj: TBCDField;
    tblSQLMeterReading___ChngdMtr_Adj: TBCDField;
    tblSQLMeterReading___ChngdMtr_Cons: TBCDField;
    tblSQLMeterReading___MR_Status: TStringField;
    tblSQLMeterReading___Remarks: TStringField;
    tblSQLMeterReading___Emp_ID: TStringField;
    tblSQLMeterReading___Time_stamp: TSQLTimeStampField;
    tblSQLMeterReading___User_ID: TStringField;
    tblSQLMeterReading___midentity: TFDAutoIncField;
    ...
    qryMSClientArrearsB_Code: TStringField;
    qryMSClientArrearsDescription: TStringField;
    qryMSClientArrearsTotalNeedToCollect: TCurrencyField;
    qryClients: TFDQuery;
    qryClientsAccountNumber: TWideStringField;
    tblClientArrears_id: TFDAutoIncField;
    tblClientArrearsAccountNo: TWideMemoField;
    tblClientArrearsDetails: TWideMemoField;
    ...
    qryMeterReadingCheck: TFDQuery;
    qryMeterReadingCheckMR_Sys_No: TStringField;
    qryMeterReadingCheckAcct_No: TStringField;
    qryMeterReadingCheckMtr_No: TStringField;
    qryMeterReadingCheckPrevMR_Date: TSQLTimeStampField;
    qryMeterReadingCheckMR_Date: TSQLTimeStampField;
    qryMeterReadingCheckPrev_Rdg: TBCDField;
    qryMeterReadingCheckCur_Rdg: TBCDField;
    qryMeterReadingCheckCur_Consumption: TBCDField;
    qryMeterReadingCheckRdg_Adj: TBCDField;
    qryMeterReadingCheckChngdMtr_Adj: TBCDField;
    qryMeterReadingCheckChngdMtr_Cons: TBCDField;
    qryMeterReadingCheckMR_Status: TStringField;
    qryMeterReadingCheckRemarks: TStringField;
    qryMeterReadingCheckEmp_ID: TStringField;
    qryMeterReadingCheckTime_stamp: TSQLTimeStampField;
    qryMeterReadingCheckUser_ID: TStringField;
    qryMeterReadingCheckmidentity: TFDAutoIncField;
    tblSQLMeterReading: TFDQuery;
